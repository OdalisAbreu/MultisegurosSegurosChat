...
<div class="row" >
    <div class="col-lg-12">
        <h3 class="page-header">Saldos retirados a Vendedor</h3>
    </div>
</div>
 ...
 <script type="text/javascript">
	...
	CargarAjax2('Admin/Sist.Distribuidor/Finanzas/retiradosCliente.php?fecha1='+fecha1+'&fecha2='+fecha2+'','','GET','cargaajax');
