...
if ($_GET['anular'] == 'si') {
	...
	//AQUI VA
	//AGREGAR FUNCION PARA VALIDAR SI YA ESTA REVERSADA Y NO ENVIAR DOS VECES
	$url2 = "https://multiseguros.com.do/ws_schat/GET_Anular.php" . "?num=" . trim($_GET['num']) . "&seg=" . trim($_GET['seg']);
...
<div class="row">
  ...
  WHERE id ='" . $row['id_cliente'] . "' LIMIT 1");
														...
														<img src="https://multiseguros.com.do/SegurosChat/images/multiseg.png" style="width: 315px; height: 70px; margin-bottom: 10px; margin-top: 10px;">
													</center>
												</td>
