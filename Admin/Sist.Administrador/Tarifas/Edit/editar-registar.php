                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="info">
                                    ...
                                    <div class="row">
                                    <div class="col-lg-12">
                                        <select name="aseguradoraId" id="aseguradoraId" style="width: 240px; height: 33px;">
                                            <option value="1">Dominicana de Seguros</option>
                                            <option value="4">ATRIO Seguros</option>
