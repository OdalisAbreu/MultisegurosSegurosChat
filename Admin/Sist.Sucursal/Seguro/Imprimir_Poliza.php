	...
	WHERE id_trans ='" .
		...
		<tr>
			<td align="left" style="border-top:solid 1px #9E9E9E; border-left:solid 1px #9E9E9E; border-bottom:solid 1px #9E9E9E; padding-left:25px; " valign="middle">
				...
				<table cellpadding="1" cellspacing="0" style="height:25px; font-size:16px;  background-color:#E0E0E0 !important; background-image:url(https://multiseguros.com.do/SegurosChat/images/fwds.jpg); background-repeat:repeat;">
					<tr>
