...
<form action="" method="post" enctype="multipart/form-data" id="form_edit_prof">
	...
	<div class="modal-header" style="margin-top: -18px; margin-bottom: -5px; padding-bottom: 0px;">
		...
		<h3>Seguro de Vehículo para <b><div id="label_veh_tipo" style="display:inline"></div> </b></h3>
	</div>
	<!-- // Modal heading END -->
...
<? } ?>
					...
					<div class="tab-pane" id="tab2" style="display:none">
                      ...
                      <div class="col-md-3 control-group">
                            ...
                            <div class="controls">
                                <input type="text"  class="form-control" name="asegurado_cedula" id="asegurado_cedula" value="<? echo $row['asegurado_cedula']; ?>" onKeyPress="return acceptNum(event)" maxlength="13" style=" width:130px"/>
                            </div>
...
<hr class="style14" id="HR<?=$nominadep['id']?>"> 
  <? } ?>
                    ...
                    <img src="images/Logo-Dominicana-de-Seguros.jpg" height="102" style="margin-bottom: -25px;
    margin-top: -6px;"> 
                    <h3 style="text-align:center">Vendiendo Seguro de Ley</h3>
                    <i style="text-align:center"> "Por favor, verifique los datos antes de proceder con la transacci&oacute;n"</i>
                    </div>
                     <div class="separator bottom"></div>
                     
                      <h5 class="heading strong text-uppercase"><b>Datos del Cliente</b></h5>
                    ...
                    <h5 class="heading strong text-uppercase"><b>Datos de Vehiculo</b></h5>
                    <table class="table table-striped table-bordered table-condensed table-white dataTable" >			
                        <tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="gradeA odd">
                    ...
                    <h5 class="heading strong text-uppercase"><b>Vigencia</b></h5>
                     <table class="table table-striped table-bordered table-condensed table-white dataTable" >			
                        <tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="gradeA odd">
                                    <td class=" sorting_1">Inicio de Vigencia <span id="vigencia_poliza"></span></td>
                                    <td class="sorting_1">Fin de Vigencia <b><div id="verfechaDV"></div></b></td>
                                </tr>
                        </tbody>
                    </table>  

					 <h5 class="heading strong text-uppercase"><b>Coberturas</b></h5>
                     <table class="table table-striped table-bordered table-condensed table-white dataTable" >			
                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                        	<tr class="gradeA odd">
                                    <td class=" sorting_1"><span id="label_vigencia_poliza"></span> Da&ntilde;os a la Propiedad Ajena</td>
                                    <td class="sorting_1"><span id="DPA"> </span></td>
                                </tr>
                                <tr class="gradeA odd">
                                    <td class=" sorting_1"><span id="label_vigencia_poliza"></span> Responsabilidad Civil 1<br />
(Lesiones Corporales o Muerte 1 Persona)</td>
                                    <td class="sorting_1"><span id="RCA"> </span></td>
                                </tr>
                                <tr class="gradeA odd">
                                    <td class=" sorting_1"><span id="label_vigencia_poliza"></span> Responsabilidad Civil +1<br />
(Lesiones Corporales o Muerte M&aacute;s de 1 Persona)</td>
