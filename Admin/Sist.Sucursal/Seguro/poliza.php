...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="../../../css/bootstrap-5.2.1/css/bootstrap.min.css" rel="stylesheet">
...
<DIV ID="ImprimirTicket" align="center" class="container">
  <table style="border:solid 1px #CCC; border-radius: 10px;" class="mt-2" >
    <tr>
      <td  class="py-4 px-2">
        <!-- TABLA UNO -->
        <table width="300" border="0" style=" font-size: 14px;  padding-left:10px; padding-right:10px;" class="p-4" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="2">
              <center>
  ...
  WHERE id ='" . $row['id_cliente'] . "' LIMIT 1");
		...
		FROM servicios WHERE id='" . $id . "' LIMIT 1");
          ...
          ?>
              <tr>
                <td colspan="2">No tiene ningun servicio incluido</td>
